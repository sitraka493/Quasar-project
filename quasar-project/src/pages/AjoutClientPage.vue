        ...
        <q-form @submit.stop="onSubmit" class="q-pa-md">
          <div class="q-gutter-md full-width">
            <div class="q-gutter-md">
              ...
              <q-input filled v-model="clientItem.email" label="Email" />
              <q-input filled v-model="clientItem.fax" label="Fax" />
            </div>
            <div>
              <q-btn color="primary" label="Ajouter le client" type="submit" />
              <q-btn
